...
const validateExperience = values => {
    ...
    values.heroExperiences.forEach(element => {
        ...
        // if (element.workscope.length > 20) {
        //     errors.workscope = 'Must be 20 characters or less';
        // }
    });
...
const WebShopInventory = (props) => {
    ...
    const handleDeletion = (e, indexTo, values) => {
        //const length = values.heroExperiences[index].heroExperienceDetails.length;
                                ...
                                <Form>
                                    <div className="form-card">
                                        ...
                                        <div className="webcast-input-field position-relative">
                                            ...
                                            onChange={(e) => selectFileHandler(e, "", "webcast", "hero")}/>
                                                ...
                                                return (
                                                    <div className="row mb-2">
                                                        <fieldset className="border p-2" key={index}>
                                                            ...
                                                            {/* <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Detail: </label>
                                                                <input type="text" name={`heroPortfolios[${index}].detail`} placeholder="Detail"
                                                                className={(errors.detail) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.detail}/>
