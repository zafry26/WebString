...
const WebCastPage = (props) => {
    ...
    const [initialValues, setInitialValues] = React.useState({
        ...
        heroPortfolios : [{
            ...
            title: '',
            detail: '',
            heroPortfolioDetails: {title:'', detail:'', heroPortfolioImages:[]}    
        }],
        heroTechnicals : [{
            image: '',
            title: '',
    ...
    const handleAddition = (e, tag ,values) => {
        const heroExperience = values.heroExperiences.map((image, index) => index === e ? 
            {
                ...values.heroExperiences[e],
                heroExperienceDetails : [...values.heroExperiences[e].heroExperienceDetails, {id:0, workScope: tag}]
            } 
    ...
    const handleDeletion = (e, indexTo, values) => {
        let heroExperienceDetails = values.heroExperiences[e].heroExperienceDetails.splice(indexTo, 1)

        const heroExperience = values.heroExperiences.map((image, index) => index === e ? 
            {
                ...values.heroExperiences[e],
                heroExperienceDetails : values.heroExperiences[e].heroExperienceDetails
            } 
            : {...values.heroExperiences[index]}
        )
            ...
            await props.getHero().then((response) => {
                if(!response.hasErrors)
                {
                    if(response.value.value !== null && response.value.value !== undefined)
                    {
                        ...
                        {
                            const heroPortfolios = responseData.heroPortfolios.map((value, index) => 
                                {
                                    return {
                                        ...value,
                                        heroPortfolioDetails: value.heroPortfolioDetails ?
                                        value.heroPortfolioDetails : { title:'', detail:'', heroPortfolioDetails:[] }
                                    }
                                } 
                            )
                            setInitialValues((prevState) => ({
    ...
    const selectFileHandler = async (event, value, module, section, index, detail) =>{
    ...
    const UploadS3 = async (value, file, fileName, module, section, index, detail) => {
        await props.uploadImage(file, fileName, module, section).then((response) => {
            if(!response.hasErrors)
            {
                if(section === 'service')
                {
                    setInitialValues((prevState) => ({
                        ...prevState,
                        heroServices : prevState.heroServices.map((initialValueCurrent, indexCurrent) => {
                ...
                if(section === 'technical')
                {
                    setInitialValues((prevState) => ({
                        ...prevState,
                        heroTechnicals : prevState.heroTechnicals.map((initialValueCurrent, indexCurrent) => {
                            var returnValue = {...initialValueCurrent};
                ...
                if(section === 'portfolio')
                {
                    setInitialValues((prevState) => ({
                        ...prevState,
                        heroPortfolios : prevState.heroPortfolios.map((initialValueCurrent, indexCurrent) => {
                            var returnValue = {...initialValueCurrent};
                            ...
                            if(detail)
                            {
                                if (indexCurrent === index) {
                                    ...
                                    returnValue.heroPortfolioDetails.title = value.heroPortfolioDetails.title;
                                    returnValue.heroPortfolioDetails.detail = value.heroPortfolioDetails.detail;
                                    returnValue.heroPortfolioDetails.heroPortfolioImages.push({"image": response.value});
                                }
                            }
                            else{
                                if (indexCurrent === index) {
                ...
                <div className="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-8 text-center p-0 mt-3 mb-2">
                    <div className="card px-0 pt-1 pb-0 mt-0 mb-3">
                        ...
                        <div id="msform">
                            {/* <!-- progressbar --> */}
                            <ul id="progressbar">
                                <li className="bi bi-person-bounding-box active" id="heroField"><strong>Hero</strong></li>
                                <li className="bi bi-person-lines-fill" id="summaryField"><strong>Summary</strong></li>
                                <li className="bi bi-mortarboard-fill" id="educationField"><strong>Education</strong></li>
                                <li className="bi bi-briefcase-fill" id="experienceField"><strong>Experience</strong></li>
                                <li className="ri-service-fill" id="serviceField"><strong>Service</strong></li>
                                <li className="ri-folder-user-fill" id="portfolioField"><strong>Portfolio</strong></li>
                                <li className="ri-list-settings-fill" id="skillField"><strong>Skill</strong></li>
                                ...
                                <Form>
                                    <div className="form-card">
                                        ...
                                        <div className="webcast-input-field position-relative">
                                            <label htmlFor="fullName" className="fieldlabels">Full Name: </label>
                                            ...
                                            {errors.fullName ? <div className="invalid-tooltip">{errors.fullName}</div> : null}
                                        </div>
                                        <div className="webcast-input-field position-relative">
                                            <label htmlFor="displayName" className="fieldlabels">Display Name: *</label>
                                            ...
                                            {errors.displayName ? <div className="invalid-tooltip">{errors.displayName}</div> : null}
                                        </div>
                                        <div className="webcast-input-field position-relative">
                                        ...
                                        <div className="webcast-input-field position-relative">
                                            <label htmlFor="backgroundImage" className="fieldlabels">Background Image: </label>
                                            <input id="backgroundImage" type="file" name="backgroundImage" placeholder="Background Image"
                                            onChange={(e) => selectFileHandler(e, values, "webcast", "hero")}/>
                                            {errors.backgroundImage ? <div className="invalid-tooltip">{errors.backgroundImage}</div> : null}
                                        </div>
                                        {values.backgroundImage !== "" ? 
                                            <div className="webcast-input-field position-relative">
                                                <img id="background" style={{width:"100%"}} src={values.backgroundImage} alt="your image" />
                                            </div>
                                            : null
                                        }
                                    </div>
                            ...
                            >
                                ...
                                <Form>
                                   <div className="form-card">
                                        ...
                                        <div className="webcast-input-field position-relative">
                                            <label htmlFor="summary" className="fieldlabels">Summary: </label>
                                            <input id="summary" type="text" name="heroSummary.summary" placeholder="Summary" 
                                            className={(errors.summary) ? 'form-control is-invalid' : 'form-control'}
                                            onChange={handleChange} 
                                            onBlur={handleBlur} 
                                            value={values.heroSummary.summary}/>
                                            {errors.summary ? <div className="invalid-tooltip">{errors.summary}</div> : null}
                                        </div>
                                        <div className="webcast-input-field position-relative">
                                            <label htmlFor="city" className="fieldlabels">City: </label>
                                            <input id="city" type="text" name="heroSummary.city" placeholder="City"
                                            className={(errors.city) ? 'form-control is-invalid' : 'form-control'}
                                            onChange={handleChange} 
                                            onBlur={handleBlur} 
                                            value={values.heroSummary.city}/>
                                            {errors.city ? <div className="invalid-tooltip">{errors.city}</div> : null}
                                        </div>
                                        <div className="webcast-input-field position-relative">
                                            <label htmlFor="state" className="fieldlabels">State: </label>
                                            <input id="state" type="text" name="heroSummary.state" placeholder="State"
                                            className={(errors.state) ? 'form-control is-invalid' : 'form-control'}
                                            onChange={handleChange} 
                                            onBlur={handleBlur} 
                                            value={values.heroSummary.state}/>
                                            {errors.state ? <div className="invalid-tooltip">{errors.state}</div> : null}
                                        </div>
                                        <div className="webcast-input-field position-relative">
                                            <label htmlFor="country" className="fieldlabels">Country: </label>
                                            <input id="country" type="text" name="heroSummary.country" placeholder="Country"
                                            className={(errors.country) ? 'form-control is-invalid' : 'form-control'}
                                            onChange={handleChange} 
                                            onBlur={handleBlur} 
                                            value={values.heroSummary.country}/>
                                            {errors.country ? <div className="invalid-tooltip">{errors.country}</div> : null}
                                        </div>
                                        <div className="webcast-input-field position-relative">
                                            <label htmlFor="email" className="fieldlabels">Email: * </label>
                                            <input id="email" type="email" name="heroSummary.email" placeholder="Email"
                                            className={(errors.email) ? 'form-control is-invalid' : 'form-control'}
                                            onChange={handleChange} 
                                            onBlur={handleBlur} 
                                            value={values.heroSummary.email}/>
                                            {errors.email ? <div className="invalid-tooltip">{errors.email}</div> : null}
                                        </div>
                                    </div>
                                    <input type="submit" name="next" className="next action-button" disabled={isSubmitting} value="Next"/>
                                                    ...
                                                    <div className="row mb-2">
                                                        <fieldset className="border p-2" key={index}>
                                                            <div className="webcast-input-field position-relative">
                                                                ...
                                                                <input type="text" name={`heroEducations[${index}].qualification`} placeholder="Qualification"
                                                            ...
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">To Year: </label>
                                                                <input id="toYear" type="text" name={`heroEducations[${index}].toYear`} placeholder="To Year"
                                                                className={(errors.toYear) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.toYear}/>
                                                                {errors.toYear ? <div className="invalid-tooltip">{errors.toYear}</div> : null}
                                                            </div>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">University: </label>
                                                                <input id="university" type="text" name={`heroEducations[${index}].university`} placeholder="University"
                                                                className={(errors.university) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.university}/>
                                                                {errors.university ? <div className="invalid-tooltip">{errors.university}</div> : null}
                                                            </div>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">State: </label>
                                                                <input id="state" type="text" name={`heroEducations[${index}].state`} placeholder="State"
                                                                className={(errors.state) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.state}/>
                                                            ...
                                                            <div className="webcast-input-field position-relative">
                                                                ...
                                                                <input id="country" type="text" name={`heroEducations[${index}].country`} placeholder="Country"
                                                                className={(errors.country) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.country}/>
                                            ...
                                            {values.heroExperiences.map((value, index) => {
                                                return (
                                                    <div className="row mb-2">
                                                        <fieldset className="border p-2" key={index}>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">PositionTitle: </label>
                                                                <input type="text" name={`heroExperiences[${index}].positionTitle`} placeholder="Position Title"
                                                                className={(errors.positiontitle) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.positionTitle}/>
                                                                {errors.positionTitle ? <div className="invalid-tooltip">{errors.positionTitle}</div> : null}
                                                            </div>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">From Year: </label>
                                                                <input type="text" name={`heroExperiences[${index}].fromYear`} placeholder="From Year"
                                                                className={(errors.fromYear) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.fromYear}/>
                                                            ...
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">To Year: </label>
                                                                <input type="text" name={`heroExperiences[${index}].toYear`} placeholder="To Year"
                                                                className={(errors.toYear) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.toYear}/>
                                                            ...
                                                            <div className="webcast-input-field position-relative">
                                                                ...
                                                                <input type="text" name={`heroExperiences[${index}].company`} placeholder="Company"
                                                                className={(errors.company) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.company}/>
                                                                {errors.company ? <div className="invalid-tooltip">{errors.company}</div> : null}
                                                            </div>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">State: </label>
                                                                <input type="text" name={`heroExperiences[${index}].state`} placeholder="State"
                                                                className={(errors.state) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.state}/>
                                                            ...
                                                            <div className="webcast-input-field position-relative">
                                                                ...
                                                                <input type="text" name={`heroExperiences[${index}].city`} placeholder="City"
                                                                className={(errors.city) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.city}/>
                                                            ...
                                                            <div>
                                                                <label className="fieldlabels">Work Scope: </label>
                                                                <ReactTags className="col-6"
                                                                    tags={values.heroExperiences[index].heroExperienceDetails.map(value => (
                                                                        {
                                                                            id: value.id,
                                                        ...
                                                        <button type="button" onClick={() => remove(index)} 
                                                        className="btn btn-primary"><i className="bi bi-dash-circle"></i><span>&nbsp;&nbsp;</span>Remove Experience</button>
                                                    </div>
                                                );
                                            })}
                                            <div className="row">
                                                <button type="button" onClick={() => {
                                                    let arr = [...initialValues.heroExperiences]
                                                ...
                                                className="btn btn-primary"><i className="bi bi-plus-square-fill"></i><span>&nbsp;&nbsp;</span>Add Experience</button>
                                            </div>
                                            </div>
                                        )}
                                        </FieldArray>
                                            ...
                                            {values.heroServices.map((value, index) => {
                                                return (
                                                    <div className="row mb-2">
                                                        <fieldset className="border p-2" key={index}>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Image: </label>
                                                                <input type="file" name={`heroServices[${index}].image`} placeholder="Image"
                                                                onChange={(e) => selectFileHandler(e, value, "webcast", "service", index)}/>
                                                                {errors.image ? <div className="invalid-tooltip">{errors.image}</div> : null}
                                                            </div>
                                                            {value.image !== "" ? 
                                                                <div className="webcast-input-field position-relative" style={{textAlign:"center"}}>
                                                                    <img id="background" style={{width:"100px",height:"100px"}} src={value.image} alt="your image" />
                                                                </div>
                                                                : null
                                                            }
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Title: </label>
                                                                <input type="text" name={`heroServices[${index}].title`} placeholder="Title"
                                                                className={(errors.title) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.title}/>
                                                                {errors.title ? <div className="invalid-tooltip">{errors.title}</div> : null}
                                                            </div>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Detail: </label>
                                                                <input type="text" name={`heroServices[${index}].detail`} placeholder="Detail"
                                                                className={(errors.detail) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.detail}/>
                                                                {errors.detail ? <div className="invalid-tooltip">{errors.detail}</div> : null}
                                                            </div>
                                                        </fieldset>
                                                        <button type="button" onClick={() => remove(index)} 
                                                        className="btn btn-primary"><i className="bi bi-dash-circle"></i><span>&nbsp;&nbsp;</span>Remove Service</button>
                                                    </div>
                                                );
                                            })}
                                            <div className="row">
                                                ...
                                                className="btn btn-primary"><i className="bi bi-plus-square-fill"></i><span>&nbsp;&nbsp;</span>Add Service</button>
                                            </div>
                                            </div>
                                        )}
                                        </FieldArray>
                                            ...
                                            {values.heroPortfolios.map((value, index) => {
                                                return (
                                                    <div className="row mb-2">
                                                        <fieldset className="border p-2" key={index}>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Portfolio Image: </label>
                                                                <input type="file" name={`heroPortfolios[${index}].image`} placeholder="Image"
                                                                onChange={(e) => selectFileHandler(e, value, "webcast", "portfolio", index)}/>
                                                                {errors.image ? <div className="invalid-tooltip">{errors.image}</div> : null}
                                                            </div>
                                                            {value.image !== "" ? 
                                                                <div className="webcast-input-field position-relative">
                                                                    <img id="background" style={{width:"100%"}} src={value.image} alt="your image" />
                                                                </div>
                                                                : null
                                                            }
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Category: </label>
                                                                <input type="text" name={`heroPortfolios[${index}].category`} placeholder="Category"
                                                                className={(errors.category) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.category}/>
                                                                {errors.category ? <div className="invalid-tooltip">{errors.category}</div> : null}
                                                            </div>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Title: </label>
                                                                <input type="text" name={`heroPortfolios[${index}].title`} placeholder="Title"
                                                                className={(errors.title) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.title}/>
                                                            ...
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Portfolio Images Detail: </label>
                                                                <Dropzone style={dropzoneStyle} name={`heroPortfolios[${index}].image`} accept="image/*" onDrop={(acceptedFiles) => {
                                                                        // do nothing if no files
                                                                        if (acceptedFiles.length === 0) { return; }

                                                                        // on drop we add to the existing files
                                                                        selectFileHandler(acceptedFiles, value, "webcast", "portfolio", index, "detail")
                                                                    }}>
                                                                    {({ isDragActive, isDragReject, acceptedFiles, rejectedFiles }) => {
                                                                        ...
                                                                        if (!value.heroPortfolioDetails.heroPortfolioImages.length) { 
                                                                            return <p>Try dragging a image here!</p>
                                                                        }

                                                                        return value.heroPortfolioDetails.heroPortfolioImages?.map((file, i) => (
                                                                            <img id="background" style={{width:"200", height:"200"}} src={file.image} alt="your image" />
                                                                        ));
                                                                    }}
                                                                </Dropzone>
                                                            </div>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Detail Title: </label>
                                                                <input type="text" name={`heroPortfolios[${index}].heroPortfolioDetails.title`} placeholder="Title"
                                                                className={(errors.titleDetail) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.heroPortfolioDetails.title}/>
                                                                {errors.titleDetail ? <div className="invalid-tooltip">{errors.titleDetail}</div> : null}
                                                            </div>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Detail Content: </label>
                                                                <input type="text" name={`heroPortfolios[${index}].heroPortfolioDetails.detail`} placeholder="Title"
                                                                className={(errors.contentDetail) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.heroPortfolioDetails?.detail}/>
                                                                {errors.contentDetail ? <div className="invalid-tooltip">{errors.contentDetail}</div> : null}
                                                            </div>
                                                        </fieldset>
                                                        <button type="button" onClick={() => remove(index)} 
                                                        className="btn btn-primary"><i className="bi bi-dash-circle"></i><span>&nbsp;&nbsp;</span>Remove Portfolio</button>
                                                    </div>
                                                );
                                            })}
                                            <div className="row">
                                                ...
                                                className="btn btn-primary"><i className="bi bi-plus-square-fill"></i><span>&nbsp;&nbsp;</span>Add Portfolio</button>
                                            </div>
                                            </div>
                                        )}
                                        </FieldArray>
                                                ...
                                                return (
                                                    <div className="row mb-2">
                                                        <fieldset className="border p-2" key={index}>
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Image: </label>
                                                                <input type="file" name={`heroTechnicals[${index}].image`} placeholder="Image"
                                                                onChange={(e) => selectFileHandler(e, value, "webcast", "technical", index)}/>
                                                                {errors.image ? <div className="invalid-tooltip">{errors.image}</div> : null}
                                                            </div>
                                                            {value.image !== "" ? 
                                                                <div className="webcast-input-field position-relative">
                                                            ...
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Title: </label>
                                                                <input type="text" name={`heroTechnicals[${index}].title`} placeholder="Title"
                                                                className={(errors.title) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.title}/>
                                                            ...
                                                            <div className="webcast-input-field position-relative">
                                                                <label className="fieldlabels">Detail: </label>
                                                                <input type="text" name={`heroTechnicals[${index}].detail`} placeholder="Detail"
                                                                className={(errors.detail) ? 'form-control is-invalid' : 'form-control'}
                                                                onChange={handleChange} 
                                                                onBlur={handleBlur} 
                                                                value={value.detail}/>
                                                        ...
                                                        <button type="button" onClick={() => remove(index)} 
                                                        className="btn btn-primary"><i className="bi bi-dash-circle"></i><span>&nbsp;&nbsp;</span>Remove Technical</button>
                                                    </div>
                                                );
                                            })}
                                            <div className="row">
                                                ...
                                                className="btn btn-primary"><i className="bi bi-plus-square-fill"></i><span>&nbsp;&nbsp;</span>Add Technical</button>
                                            </div>
                                            </div>
                                        )}
                                        </FieldArray>
